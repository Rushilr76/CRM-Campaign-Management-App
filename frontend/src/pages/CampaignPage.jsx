...
const CampaignPage = () => {
    ...
    useEffect(() => {
        ...
        fetch("https://crm-app-backend-cjvk.onrender.com/api/communicationLog")
            .then(response => response.json())
            .then((data) => {
    ...
    const sendCurrentCampaignMessage = async () => {
        ...
        try {
            const messageResponse = await fetch("https://crm-app-backend-cjvk.onrender.com/api/messages", {
                method: "POST",
